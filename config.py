...
class Config:
    ...
    def post_value_updates(cls):
        if 'porto' == cls.dataset:
            ...
            # cls.max_lon = -8.5192
            # cls.max_lat = 41.2086
            cls.dataset_prefix = 'porto_all'
            cls.min_lon = -8.73
            cls.min_lat = 41.10
            cls.max_lon = -8.5
            cls.max_lat = 41.24
        elif 'geolife' == cls.dataset:
            cls.dataset_prefix = '0_geolife'
            cls.min_lon = 116.200047
            cls.min_lat = 39.851057
            cls.max_lon = 116.499288
            cls.max_lat = 40.0699999
        else:
            pass
        ...
        set_seed(cls.seed)
        cls.final_embedding_path = "/mnt/data_hdd1/czh/TrajCL/data/" + cls.dataset_prefix + '_' + str(cls.seed) + '_' + str(cls.trajsimi_measure_fn_name)
