...
def my_clean_and_output(traj_path):
    print("Load")
    traj_list = pickle.load(open(traj_path, "rb"))
    print("Load End")
    length_list = [len(value) for value in traj_list]
    dic = {"wgs_seq" : traj_list,
           "trajlen" : length_list}
    dfraw = pd.DataFrame(dic)
...
if __name__ == '__main__':
    ...
    my_clean_and_output("/mnt/data_hdd1/czh/Neutraj/0_geolife/traj_list")
